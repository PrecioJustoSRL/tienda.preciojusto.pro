...
export default function Button({ theme, styled, click, children }) {
    ...
    return (<div className={` transition-all ease-in-out duration-300  z-40`}>
        <button type="button" onClick={HandlerCheckOut} class="h-[40px] w-[40px] my-1 text-blue-700 bg-[#2A52BE] border-[2px] border-white font-medium rounded-full text-sm p-2.5 text-center flex justify-center items-center ">
            {tienda !== 'Recetar'
