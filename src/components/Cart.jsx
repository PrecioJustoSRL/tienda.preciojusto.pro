...
export default function Button({ theme, styled, click, children }) {
    ...
    return (<div className={` transition-all ease-in-out duration-300  z-40`}>
        <button type="button" onClick={HandlerCheckOut} className="h-[40px] w-[40px] my-1 text-blue-700 bg-[#2A52BE] border-[2px] border-white font-medium rounded-full text-sm p-2.5 text-center flex justify-center items-center ">
            {tienda !== 'Recetar'
                ...
                : <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12.7273 5.45455H3.63636V3.63636H12.7273V5.45455ZM16.3636 13.1036V20H0V0H16.3636V3.26L21.2855 8.18182L16.3636 13.1036ZM16.4418 10.4545L14.0909 8.10364L10 12.1945V14.5455H12.3509L16.4418 10.4545ZM16.3636 5.83091L15.3764 6.81818L17.7273 9.16909L18.7145 8.18182L16.3636 5.83091ZM14.5455 14.9218L13.1036 16.3636H3.63636V14.5455H8.18182V12.7273H3.63636V10.9091H8.71455L10.5327 9.09091H3.63636V7.27273H12.3509L14.5455 5.07818V1.81818H1.81818V18.1818H14.5455V14.9218Z" fill="white" />
                </svg>}
            <span className='inline-block absolute top-[10px] text-white right-[10px] bg-[#2A52BE] w-[16px] text-[12px] rounded-full border border-white'>{
...
{/* <div className={`fixed right-[20px] transition-all ease-in-out duration-300 ${add ? 'bottom-[150px] lg:bottom-[73px]' : 'bottom-[-200px] lg:bottom-[73px]'} z-40`}>
    <button type="button" onClick={() => funcion('Portada')} className="h-[50px] w-[50px] my-1 text-blue-700 bg-gray-950 border border-gray-700 hover:bg-gray-500 hover:text-white focus:outline-none focus:ring-gray-500 font-medium rounded-full text-sm p-2.5 text-center flex justify-center items-center ">
    ...
    <button type="button" onClick={() => funcion('Servicios')} className="h-[50px] w-[50px] my-1 bg-gray-950 border border-gray-700 hover:bg-gray-500 hover:text-white focus:outline-none focus:ring-gray-500 font-medium rounded-full text-sm text-center flex justify-center items-center p-0">
    ...
    <button type="button" onClick={() => funcion('Testimonios')} className="h-[50px] w-[50px] my-1 text-blue-700 bg-gray-950 border border-gray-700 flex- hover:bg-gray-500 hover:text-white focus:outline-none focus:ring-gray-500 font-medium rounded-full text-sm p-2.5 text-center flex justify-center items-center ">
